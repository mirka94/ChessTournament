...
\input{czlonkowie/1/main.tex}%Piotr Jabłoński - kierownik zespołu
\input{czlonkowie/2/main.tex}%Mariusz Lorek		
\input{czlonkowie/3/main.tex}%Mirosława Pelc
\input{bibrystab.tex} %Każdy członek zespołu musi dołożyć minimum 5 pozycji bibliograficzny, które posłużyły mu do opracowania zadanego fragmentu projektu.
\end{document}
